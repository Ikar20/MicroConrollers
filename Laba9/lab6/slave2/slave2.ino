...
void sendMessage(int recevierId, char str[], long sizeOf) {
  ...
  long crc = calculateAlgorithmicImplementationGenibusCrc(str, sizeOf / sizeof(char) - 1, 0x9B, 0x00, true, true, 0x00, 8);
  delay(60);
